...
class Ensemble_ExplainableBoostingRegressor:
    ...
    def fit(self, train_x, train_y):
        ...
        for i in range(self.ensemble_n_estimators):
            ...
            self.regressors_train_score.append(ebr.score(sampled_train_x, sampled_train_y))
...
class Ensemble_CatBoostRegressor:
    ...
    def fit(self, train_x, train_y):
        ...
        for i in range(self.ensemble_n_estimators):
            ...
            self.regressors_train_score.append(cbr.score(sampled_train_x, sampled_train_y))
            self.regressors_x_columns.append(used_columns)
...
class Ensemble_LGBMRegressor:
    ...
    def fit(self, train_x, train_y):
        ...
        for i in range(self.ensemble_n_estimators):
            ...
            self.regressors_train_score.append(lgbr.score(sampled_train_x, sampled_train_y))
            self.regressors_x_columns.append(used_columns)
...
class Ensemble_XGBRegressor:
    ...
    def fit(self, train_x, train_y):
        ...
        for i in range(self.ensemble_n_estimators):
            ...
            self.regressors_train_score.append(xgbr.score(sampled_train_x, sampled_train_y))
            self.regressors_x_columns.append(used_columns)
...
class Ensemble_GradientBoostingRegressor:
    ...
    def fit(self, train_x, train_y):
        ...
        for i in range(self.ensemble_n_estimators):
            ...
            self.regressors_train_score.append(gbr.score(sampled_train_x, sampled_train_y))
            self.regressors_x_columns.append(used_columns)
...
class Ensemble_HistGradientBoostingRegressor:
    ...
    def fit(self, train_x, train_y):
        ...
        for i in range(self.ensemble_n_estimators):
            ...
            self.regressors_train_score.append(hgbr.score(sampled_train_x, sampled_train_y))
            self.regressors_x_columns.append(used_columns)
